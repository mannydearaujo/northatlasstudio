...
Check title, meta description, canonical, one H1, H2/H3 hierarchy, LocalBusiness/ProfessionalService schema, Service schema where appropriate, FAQPage only for visible FAQs, BreadcrumbList matching visible breadcrumbs, sitemap entry, and robots/canonical status.
