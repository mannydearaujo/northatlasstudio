...
4. **Apply the anti-AI pass.** Posts must sound like the owner posted them. Read 2–3 through the `de-ai-copy` lens: no "Did you know…?", no "We're thrilled to announce," no emoji walls.
...
- Log posting activity so `report-to-client` can report "what we did" accurately.
