# Oferta / Follow-Up De Auditoria Em pt-BR
...
- 2 a 3 achados selecionados, em linguagem simples.
- O impacto prático: mais clareza, mais fácil de encontrar e entender, menos fricção para ligar ou pedir orçamento.
- Uma recomendação principal de escopo.
- Preço ou faixa fechada quando Manny já definiu.
- Prova aprovada.
- Linguagem sem garantia.
- Um próximo passo claro.

Não inclua:

- Notas internas.
- Exploração de preço, margem ou desconto.
- Todos os achados brutos da auditoria.
- Comentários marcados como internos.
- Promessas de ranking, Google Maps, AI Overview, AI Mode ou volume garantido de leads.
...
3. **O que eu recomendo fazer agora**
   Escolha uma oferta principal. Não despeje o menu completo.

4. **Escopo**
   Liste entregáveis objetivos: páginas, ajustes de CTA, schema, GA4/GTM, Search Console, GBP, relatório.
...
- "mais clareza para quem está procurando"
- "mais fácil de encontrar e entender"
- "ligações, pedidos de orçamento, agendamentos e formulários"
- "rastreamento honesto no GA4"
- "próximos passos claros"
- "sem prometer ranking ou volume garantido"

## Frases Para Evitar

- "garantimos primeira posição"
- "dominamos o Google"
- "apareça em todas as respostas de IA"
...
- [Entregável 2]
- [Entregável 3]
- [Rastreamento GA4/GTM de leads reais]
- [Relatório simples após entrega, se aplicável]
